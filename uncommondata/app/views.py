...
MOOOOO!"""
    ...
    try:
        ...
        prompt = f"Tell me a knock-knock joke about {topic}. Just give me the joke, no extra explanation making sure to use the exact phrase without commas Knock knock"
